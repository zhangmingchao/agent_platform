...
class RuntimeServiceTests(unittest.TestCase):
    ...
    def test_rewrites_known_mnt_data_path(self) -> None:
    ...
    def test_keeps_unknown_mnt_data_path(self) -> None:
        """未上传的文件路径不应被猜测或替换。"""
    ...
    def test_workspace_is_scoped_inside_single_user_container(self) -> None:
    ...
    def test_workspace_defaults_to_session(self) -> None:
