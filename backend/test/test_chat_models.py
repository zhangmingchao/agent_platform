...
class ChatModelTests(unittest.TestCase):
    def test_session_and_agent_rows_are_converted_to_entities(self):
    ...
    def test_runtime_file_attachment_does_not_expose_storage_path(self):
    ...
    def test_prepare_chat_run_declares_entity_return_type(self):
        """聊天准备函数应明确声明返回 PreparedChatRun，而不是普通 dict。"""
        self.assertIs(prepare_chat_run.__annotations__["return"], PreparedChatRun)

    def test_agent_factory_declares_compiled_graph_return_type(self):
