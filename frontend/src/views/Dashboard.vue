        ...
        <el-card>
          <template #header>
            <div class="card-header">
              <span>{{ t('dashboard.recentAgents') }}</span>
              <el-button type="primary" link @click="$router.push('/agents')">{{ t('dashboard.viewAll') }}</el-button>
            </div>
          </template>
          <el-table :data="recentAgents" :empty-text="t('dashboard.noAgents')">
            ...
            <el-table-column :label="t('dashboard.actions')" width="160">
              <template #default="{ row }">
                <el-button type="primary" link @click="$router.push(`/agents/${row.id}/chat`)">{{ t('dashboard.chat') }}</el-button>
                <el-button link @click="$router.push(`/agents/${row.id}/edit`)">{{ t('dashboard.edit') }}</el-button>
              </template>
            </el-table-column>
          </el-table>
        </el-card>
